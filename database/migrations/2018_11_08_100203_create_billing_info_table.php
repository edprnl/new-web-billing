...
class CreateBillingInfoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('b_billing_info', function (Blueprint $table) {
            ...
            $table->decimal('total_vat', 15, 5)->nullable(true);
            $table->decimal('total_amount_due', 15, 5)->nullable(true);
            $table->decimal('total_adjusted_in', 15, 5)->nullable(true);
            $table->decimal('total_adjusted_out', 15, 5)->nullable(true);
            $table->boolean('is_approved')->default(0);
            $table->decimal('wtax_amount', 15, 5)->nullable(true);
